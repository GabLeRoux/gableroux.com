# Django settings for gableroux project.
...
SECRET_KEY = 'jQ!SJRM4)bLBK0QwNG1+_EuRLsG$)#aN-LD!iAFx$PinQs+Rta'
...
ROOT_URLCONF = 'gableroux.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'gableroux.wsgi.application'
...
EMAIL_SUBJECT_PREFIX = '[gableroux] '
